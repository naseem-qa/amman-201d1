...
function getGoatTitles() {

  var goatTitles = [];

  for(var i = 0; i < Goat.all.length; i++) {
    var goatInstance = Goat.all[i];
    goatTitles.push(goatInstance.title + ' clicked');
    goatTitles.push(goatInstance.title + ' shown');
  }
  return goatTitles;
}
      ...
      datasets: [
        {
          ...
          data: [3,4,5,6,1,1,2,3,8,10,9,11,3,5,4,4]
        }
      ]
    },
